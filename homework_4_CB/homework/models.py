...
def extract_peak(heatmap, max_pool_ks=7, min_score=-5, max_det=100):
    ...
    window_max, indices = F.max_pool2d(heatmap, kernal_size=max_pool_ks, padding = (max_pool_ks-1)//2, stride = 1, return_indices=True)
    peak_ind = torch.logical(heatmap >= window_max, window_max > min_score)
